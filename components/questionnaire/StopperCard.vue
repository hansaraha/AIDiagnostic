<template>
  <Teleport to="body" v-if="show">
    <div :style="{ backgroundImage: `url('/images/blob-trans.png')` }"
      class="fixed inset-0 bg-[#292859] z-50 flex items-center justify-center px-5 bg-no-repeat bg-right md:bg-center">
      <div class="space-y-8">
        <p class="font-semibold text-3xl text-white">Sabìas que...</p>
        <div
          class="w-full relative max-w-xl px-4 py-6 bg-indigo-950 bg-opacity-50 backdrop-blur-lg  rounded-xl border space-y-5 border-[#5D49F6]">
